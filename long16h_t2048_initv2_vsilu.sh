#!/usr/bin/env bash
# T=2048, 16h: dv=256 ff=4096 + init_v2 + v_silu (NO k_silu).
# k_silu was harmful — it breaks the linear structure the phase expects.
set -u
...
cell t2048_initv2_v --layer-scale --lam-free --damp-mem 4,20000 --gdn-gate --v-silu --init-v2
echo "##### DONE"

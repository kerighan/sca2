#!/usr/bin/env bash
# d=1024: gdngate + Ls=256 (quadruple the short-head window).
# Ls=128 improved over Ls=64 by -0.015 consistently. Ls=256 covers 25% of T=1024.
set -u
...
COMMON="--data pycode_long1024_xl.pt --block 1024 --batch 8 --d 1024 --layers 8
        ...
        --variant lapa_cc --Mc 256 --dv 256 --Ls 256 --theta-scale 0.02
...
cell d1024_gdngate_L256 --layer-scale --lam-free --damp-mem 4,20000 --gdn-gate
echo "##### LONG5H_D1024_AH DONE"

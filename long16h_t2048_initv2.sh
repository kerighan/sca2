#!/usr/bin/env bash
# T=2048, 16h: dv=384 ff=5800 + init_v2 + v_silu.
# Calibrated init from converged checkpoints + non-linear values.
set -u
...
cell t2048_initv2 --layer-scale --lam-free --damp-mem 4,20000 --gdn-gate --v-silu --init-v2
echo "##### DONE"
